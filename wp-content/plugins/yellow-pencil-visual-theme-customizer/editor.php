...
<head>
	...
	var l18_animation_notice = "<?php _e('Animation property may not work, please set \'block\' option to display property from extra section.','yp'); ?>";
	var l18_margin_notice = "<?php _e('Margin property may not work, please set \'block\' or \'inline-block\' option to display property from extra section.','yp'); ?>";
	var l18_padding_notice = "<?php _e('Padding property may not work, please set \'block\' or \'inline-block\' option to display property from extra section. If work please don\'t care this notice.','yp'); ?>";
...
<body class="<?php echo $classesReturn; ?>">
	...
	<div class="top-area-btn-group">
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='<?php _e('Responsive Mode','yp'); ?> <span class="yp-tooltip-shortcut"><?php _e('edit on a specific screen size','yp'); ?></span>' class="top-area-btn yp-responsive-btn active"><span class="responsive-icon"></span></div>
