...
if(!class_exists('Edge_Plus_Features')){
	class Edge_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			...
			<a href="<?php echo esc_url( 'http://themefreesia.com/theme-instruction/edge/' ); ?>" title="<?php esc_html_e( 'Theme Instructions', 'edge' ); ?>" target="_blank" id="about_edge">
			<?php esc_html_e( 'Theme Instructions', 'edge' ); ?>
			</a><br/>
			<a href="<?php echo esc_url( 'http://themefreesia.com/support-forum/' ); ?>" title="<?php esc_html_e( 'Forum', 'edge' ); ?>" target="_blank" id="about_edge">
